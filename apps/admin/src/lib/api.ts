// apps/api'nin taban URL'i. Aynı desen apps/web ve apps/field-pwa'da da
// kullanılıyor (bkz. o dosyaların yorumu) — burada birebir kopyalandı, üç
// ayrı build sistemi arasında paylaşılan bir paket olmadığından
// (packages/shared-types henüz boş placeholder).
...
// standart pratik, apps/web/apps/field-pwa ile aynı desen.
